        ...
        <div className='mx-auto max-w-3xl text-center'>
          ...
          <motion.div custom={1} variants={fadeUpVariants} initial='hidden' animate='visible'>
            <h1 className='mb-6 text-4xl font-bold tracking-tight sm:text-6xl md:mb-8 md:text-8xl'>
              <span className='bg-linear-to-b from-white to-white/80 bg-clip-text text-transparent'>{title1}</span>
              <br />
              <span
                className={cn('bg-linear-to-r from-indigo-300 via-white/90 to-rose-300 bg-clip-text text-transparent')}
              >
                {title2}
              </span>
            </h1>
